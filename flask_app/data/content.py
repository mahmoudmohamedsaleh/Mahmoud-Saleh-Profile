"""Portfolio content data for Mahmoud Mohamed Saleh"""

PROFILE = {
    "name": "Mahmoud Mohamed Saleh",
    "title": "Presale Manager - Low Current Systems",
    "hero_description": "Presale Manager with 7+ years of end-to-end product lifecycle expertise spanning Electronics Design, SMT Manufacturing, and Presales Engineering across 12+ Low Current System categories in Saudi Arabia and the Middle East.",
    "summary": "Technical professional with 7+ years mastering the complete product lifecycle: from Electronics Design and Software Development, through SMT Manufacturing at Samsung Electronics, to Presales Engineering for Low Current System Solutions across the Middle East.",
    "summary_closing": "I bring a rare end-to-end perspective, understanding how products are designed, manufactured, and sold. This enables me to deliver tailored solutions that align technical excellence with business value, driving successful project outcomes and lasting client partnerships.",
    "stats": {
        "years_experience": "7+",
        "teams_led": "5+"
    },
    "contact": {
        "email": "mahmoud3374421@gmail.com",
        "phone": "0560706291",
        "phone_link": "+966560706291",
        "whatsapp": "0570968665",
        "whatsapp_link": "https://wa.me/966570968665",
        "location": "Al-Souweidi, Riyadh, Saudi Arabia"
    }
}
...
EXPERIENCES = [
    {
        ...
        "highlights": [
            ...
            "Designed a web-based SRM (Supplier Relationship Management) system linked with Presales Management and CRM to manage Vendors and Distributors, display supplier quotations in vendor profiles, and integrate with Procurement to show POs in Supplier/Vendor profiles",
        ],
        "full_description": [
...
EDUCATION = {
    "degree": "B.Sc. of Electrical Engineering",
    "department": "Electronics and Communication Engineering Department (ECE)",
    "university": "Ain Shams University, Cairo, Egypt",
    "period": "2013 - 2018",
    "gpa": "Very Good",
    "graduation_project": "IOT wireless Monitoring and Actuation Platform of Aquaculture (electronics circuit and embedded system design)",
}

CERTIFICATIONS = [
    {"name": "CCNA - Cisco Certified Network Associate", "icon": "shield"},
    {"name": "Light Current System Diploma - Very Good", "icon": "shield"},
    {"name": "Data Engineering Essential Course", "icon": "shield"},
    {"name": "Embedded System Diploma - Amit Learning", "icon": "shield"},
    {"name": "Communication Protocols (UART, SPI, I2C)", "icon": "cpu"},
]

LANGUAGES = [
    {"name": "Arabic", "level": "Mother Language", "variant": "primary"},
    {"name": "English", "level": "Very Good", "variant": "secondary"},
]
